...
- [x] 6.1 Обновить README с кратким описанием архитектуры и выбранного scope
- [x] 6.2 Подготовить краткое объяснение для проверяющего, почему realtime и сложная auth-логика вынесены за рамки MVP
